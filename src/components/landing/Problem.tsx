    ...
    <section className="border-y border-[color:var(--line)] bg-[color:var(--cream-2)]/50">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-12 grid md:grid-cols-4 gap-4">
          <StatBlock big="15 min" label="Average appointment window" note="Between visits your health is invisible to your care team." />
          <StatBlock big="4+" label="Portals per chronic patient" note="Records fragmented across providers, labs, pharmacies." />
          <StatBlock big="10%" label="ACE inhibitor patients develop dry cough" note="Symptoms rarely connected to the medication that caused them." />
          <StatBlock big="$120B" label="Wasted annually on duplicated tests" note="Because prior results couldn't be found in time." />
        </div>
      </div>
    </section>
  );
